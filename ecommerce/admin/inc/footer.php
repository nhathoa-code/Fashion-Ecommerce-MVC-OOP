...
<!-- Bootstrap.js -->
<script src="<?php echo "$ROOT_URL/admin/js/vendor/bootstrap.min.js" ?>"></script>
<?php if (isset($_GET['page']) && $_GET['page'] === "add_product_form") : ?>
    <script src="<?php echo "$ROOT_URL/admin/js/ckeditor/ckeditor.js" ?>"></script>
    <script src="<?php echo "$ROOT_URL/admin/js/jquery-validation/jquery.validate.min.js" ?>"></script>
    <script src="<?php echo "$ROOT_URL/content/admin/js/add_product.js" ?>"></script>
<?php endif ?>
<?php if (isset($_GET['page']) && $_GET['page'] === "product_list") : ?>
    <script src="<?php echo "$ROOT_URL/content/admin/js/list_products.js" ?>"></script>
<?php endif ?>
<?php if (isset($_GET['page']) && $_GET['page'] === "product_edit_form") : ?>
    <script src="<?php echo "$ROOT_URL/admin/js/ckeditor/ckeditor.js" ?>"></script>
    <script src="<?php echo "$ROOT_URL/content/admin/js/update_product.js" ?>"></script>
<?php endif ?>
<?php if (isset($_GET['page']) && $_GET['page'] === "order_detail") : ?>
    <script src="<?php echo "$ROOT_URL/content/admin/js/order_detail.js" ?>"></script>
<?php endif ?>
<?php if (isset($_GET['page']) && $_GET['page'] === "slider_list") : ?>
    <script src="<?php echo "$ROOT_URL/content/admin/js/slider.js" ?>"></script>
<?php endif ?>
<?php if (isset($_GET['page']) && $_GET['page'] === "order_list") : ?>
    <script src="<?php echo "$ROOT_URL/content/admin/js/list_orders.js" ?>"></script>
<?php endif ?>
<!-- Jquery plugins and custom javascript code -->
<script src="<?php echo "$ROOT_URL/admin/js/plugins.js" ?>"></script>
<script src="<?php echo "$ROOT_URL/admin/js/main.js" ?>"></script>