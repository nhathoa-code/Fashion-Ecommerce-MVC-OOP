...
<head>
    ...
    <link rel="stylesheet" href="<?php echo "$ROOT_URL/admin/css/bootstrap.css" ?>">

    <!-- Related styles of various javascript plugins -->
    <link rel="stylesheet" href="<?php echo "$ROOT_URL/admin/css/plugins.css" ?>">

    <!-- The main stylesheet of this template. All Bootstrap overwrites are defined in here -->
    <link rel="stylesheet" href="<?php echo "$ROOT_URL/admin/css/main.css" ?>">
    ...
    <?php if (isset($_GET['page']) && $_GET['page'] === "order_detail") : ?>
        <link rel="stylesheet" href="<?php echo "$ROOT_URL/admin/css/src/order_detail.css" ?>">
    <?php endif ?>
    ...
    <script src="<?php echo "$ROOT_URL/admin/js/vendor/modernizr-respond.min.js" ?>"></script>
</head>
...
<body<?php if ($template['layout'] == 'fixed') echo ' class="fixed"'; ?>>
    ...
    <div id="page-container">
        ...
        <header class="navbar navbar-inverse<?php if ($template['header'] == 'fixed-top') echo ' navbar-fixed-top';
                                            else if ($template['header'] == 'fixed-bottom') echo ' navbar-fixed-bottom'; ?>">
